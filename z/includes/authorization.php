...
// Test authorization
//
if (!isset($_SESSION['auth']) or (strval($_SESSION['auth']) !== strval(hash('sha256', $_SESSION['userIdS'] . $_SESSION['userS'] . $_SERVER['REMOTE_ADDR'] . $_SERVER['HTTP_USER_AGENT']))) or isset($_SERVER['HTTP_X_FORWARDED_FOR']) or isset($_SERVER['HTTP_X_FORWARDED']) or isset($_SERVER['HTTP_FORWARDED_FOR']) or in_array($_SERVER['REMOTE_PORT'], array(8080, 80, 6588, 8000, 3128, 553, 554))) {
